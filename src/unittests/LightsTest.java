...
public class LightsTest {
    ...
    public void sphereMultiLight() {
        ...
        scene.addLights(new DirectionalLight(new Color(500, 300, 0), new Vector(1, -1, 1)),
        		new PointLight(new Color(500, 300, 0), new Point3D(0, 0, -50), 2, 0.0001, 0.000001),
        		new SpotLight(new Color(500, 300, 0), new Point3D(-50, 50, -50),
                        new Vector(1, 2, 2), 1, 0.00001, 0.00000001));
    ...
    public void trianglesMultiLight() {
        ...
        scene.addLights(new DirectionalLight(new Color(300, 150, 150), new Vector(0, 0.25, 1)),
        		new PointLight(new Color(500, 250, 250), new Point3D(10, 50, 130), 2, 0.001, 0.0005)
        		,new SpotLight(new Color(500, 250, 250), new Point3D(-120, 90, 130), new Vector(2, -2, -1), 1, 0.0001, 0.000005)
        		);
